...
class ProductCard extends React.Component {
  ...
  updateProductState = (productToUpdate) => {
    this.setState({ productCount: productToUpdate.count }, () =>
      this.props.setProductToUpdate(productToUpdate)
    );
  };
  ...
  render() {
    return (
      <div className={styles.product_card}>
        <button
          id={styles.delete_product_button}
          onClick={() => this.props.deleteProduct(this.state.productName)}
        >
          X
        </button>
