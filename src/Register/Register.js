...
class Register extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        if (password !== confirmPassword) {
            ...
            fetch(`http://192.168.0.21:9000/register/`, { method: 'POST', headers: {
            ...
            .then((responseJson) => {
                ...
                else if (responseJson.name === "MongoError" && responseJson.keyValue.email !== undefined) {
                    console.log(responseJson)
                    this.setState({errors : ["The email address has already been taken"]})
                }

                // Username already exists in the database
                else if (responseJson.name === "MongoError" && responseJson.keyValue.username !== undefined) {
                    console.log(responseJson)
